...
export default function LoginScreen({ navigation }) {
  ...
  const onLoginPressed = () => {
    ...
    const url = 'http://localhost:8080/staff/login'; // Replace with your backend URL
  ...
  return (
    <Background>
      ...
      <Button mode="contained" onPress={onLoginPressed} disabled={loginAttempts >= MAX_LOGIN_ATTEMPTS}>
        Login
      </Button>
